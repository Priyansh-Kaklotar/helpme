...
const protectedRoutes = ['/customer/find-provider' , '/customer/dashboard' ,"/chat" ];
 // haji add karsu extra kem ke home page koi pan joi shake pan amuk route mate login ke registeration thavu pade atyare / rakhyu chhe pan pachhi booking , ke biju kak rakhshu . 
